function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        var numbers = /[0-9]/; // : Fill in the regular expression for digits
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = (myInput.innerHTML === confirmMyInput.innerHTML); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
